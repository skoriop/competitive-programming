...
template<typename T, typename... Args> void err(istream_iterator<string> it, T a, Args... args) { cerr << "\033[0;31m" << dbg_function << ":" << dbg_line << " -> \033[0;33m" << *it << " = " << a << "\033[0m" << ln; err(++it, args...);}
#ifdef LOCAL
